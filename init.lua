...
-- settings like above keymaps and etc
...
local function override_or_default(enabled, override, default)
  if not enabled or override == nil then
    return default
  else
    return override
  end
...
require('lazy').setup({
  ...
  override_or_default(overrides_enabled, local_overrides.colorscheme, {
